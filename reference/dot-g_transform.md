...
[`.g_inverse()`](https://vorpalvorpal.github.io/hydroSense/reference/dot-g_inverse.md)
for the inverse and
[`.analyte_c()`](https://vorpalvorpal.github.io/hydroSense/reference/dot-analyte_c.md)
